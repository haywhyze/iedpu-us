    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          ...
          <List>
            <ListItem>
              Foster and promote unity; progress and mutual understanding among
              the indigenes of Ilorin Emirate;
            </ListItem>
            <ListItem>
              Promote better understanding with other communities;
            </ListItem>
            <ListItem>
              Participate in the socio-economic development of the community.
            </ListItem>
          </List>
        </GridItem>
      </GridContainer>
