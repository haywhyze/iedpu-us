...
export default function ProfileModal({ classicModal, setClassicModal, meeting }) {
              ...
              <div className={profileClasses.container}>
                <h4 style={{ textAlign: 'center' }}>
                  {new Intl.DateTimeFormat('en-US', {
                    ...
                    hour: 'numeric',
                    minute: 'numeric',
                  }).format(new Date(meeting.time))}
                </h4>
                <GridContainer justify="center">
                  <GridItem xs={12} sm={12}>
                    <GridItem xs={12} sm={12}>
                      <p style={{ whiteSpace: 'pre-wrap' }}>{meeting.meetingNotes}</p>
                    </GridItem>
                    <GridItem xs={12} sm={12}>
                      <h5>
