...
export default function PrivacyPolicy() {
  return (
    <>
      <div style={{ padding: '2% 15%', color: 'white', background: '#222' }}>
        <h1>
          Ilorin Emirate Descendants Progressive Union (IEDPU), United States of
          America (USA) Branch Inc.
        </h1>
        <p>Privacy Policy of https://iedpuusa.org/</p>
      </div>
      <div className="privacy-policy">
        ...
        <ul>
          ...
          <li>
            ...
            {' '}
            refers to Ilorin Emirate Descendants
            Progressive Union USA Branch, accessible from https://iedpuusa.org/
          </li>
          <li>
        ...
        <ul>
          <li>By email: ilorinemirate19@gmail.com</li>
        </ul>
      </div>
    </>
  );
