  ...
  const createNews = () => {
    ...
    db.collection('executives')
      ...
      .then(() => {
        ...
        toast.success('Exco member successfully updated');
      })
      .catch((error) => {
        toast.error(`Error updating exco member, ${error.message}`);
      });
  };
  return (
    <div>
