...
export default function NewExecutive({ classicModal, setClassicModal }) {
  ...
  const createExecutive = () => {
    ...
    db.collection("executives")
      ...
      .then((docRef) => {
        ...
        toast.success("Exco member successfully added");
      })
      .catch((error) => {
        toast.error(`Error Creatting exco member, ${error.message}`);
      });
  };
          ...
          >
            ...
            >
              <CardBody>
                <GridContainer>
                  <GridItem xs={12}>
                    <h2>Add new Executive Member</h2>
                  </GridItem>
                  <GridItem xs={12}>
                    <CustomInput
                      labelText="Name"
