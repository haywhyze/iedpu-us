...
export default function NewExecutive({
  classicModal,
  setClassicModal,
}) {
  ...
  const createExecutive = () => {
    ...
    db.collection('executives')
      ...
      .then((docRef) => {
        ...
        toast.success('Advisory Council member successfully added');
      })
      .catch((error) => {
        toast.error(`Error Creatting Advisory Council member, ${error.message}`);
      });
  };
          ...
          >
            ...
            >
              <CardBody>
                <GridContainer>
                  <GridItem xs={12}>
                    <h2>Add new Advisory Council Member</h2>
                  </GridItem>
                  <GridItem xs={12}>
                    <CustomInput
                      labelText="Name"
            ...
            <DialogActions className={classes.modalFooter}>
              <Button onClick={createExecutive} color="primary">
                Create Advisory Council member
              </Button>
            </DialogActions>
          </Dialog>
        </GridItem>
